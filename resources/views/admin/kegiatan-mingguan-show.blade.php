            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="{{ route('admin.kegiatan-mingguan-update',['id' => $kegiatan->id]) }}" method="POST">
                            @csrf
                            @method('put')
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Minggu Ke</label>
                                    <input type="Number" name="kegiatan_mingguan" class="form-control" id=""
                                        placeholder="Input hanya nomber" value="{{ $kegiatan->kegiatan_mingguan }}">
                                </div>
                                @error('email')
                                    <p>{{ $message }}</p>
                                @enderror
